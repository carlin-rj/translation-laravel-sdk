...
class CollectActiveCommand extends Command
{
    ...
    protected $description = '全局扫描项目中的 __/trans/@lang 调用，并批量采集到翻译中台';

    public function handle(ActiveCollector $collector): int
    {
        ...
        $result = $collector->collect($paths, $batchSize);
